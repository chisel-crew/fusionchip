...
class TLBufferNodeAndNotCancel(a: BufferParams, b: BufferParams, c: BufferParams, d: BufferParams, e: BufferParams)(
  implicit valName: ValName
) extends TLAdapterNodeAndNotCancel(
      clientFn = { p => p.v1copy(minLatency = p.minLatency + b.latency + c.latency) },
      managerFn = { p => p.v1copy(minLatency = p.minLatency + a.latency + d.latency) }
    ) {
  override lazy val nodedebugstring =
...
class TLBufferAndNotCancel(a: BufferParams, b: BufferParams, c: BufferParams, d: BufferParams, e: BufferParams)(
  implicit p: Parameters
) extends LazyModule {
  def this(ace: BufferParams, bd: BufferParams)(implicit p: Parameters) = this(ace, bd, ace, bd, ace)
  def this(abcde: BufferParams)(implicit p: Parameters) = this(abcde, abcde)
...
object TLBufferAndNotCancel {
  ...
  def apply(ace: BufferParams, bd: BufferParams)(implicit p: Parameters): TLMixedNodeCancel =
