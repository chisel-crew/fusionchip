...
trait CanAttachTLSlaves extends HasTLBusParams { this: TLBusWrapper =>
  ...
  def toFixedWidthSlaveNode(name: Option[String] = None, buffer: BufferParams = BufferParams.none)(
    gen: TLInwardNode
  ): Unit =
...
trait CanAttachTLMasters extends HasTLBusParams { this: TLBusWrapper =>
  ...
  def fromMasterNode(name: Option[String] = None, buffer: BufferParams = BufferParams.none)(gen: TLOutwardNode): Unit =
