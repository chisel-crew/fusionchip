...
class Rocket(tile: RocketTile)(implicit p: Parameters)
  ...
  @chiselName class RocketImpl extends NoChiselNamePrefix { // entering gated-clock domain
    ...
    val ex_cannot_bypass =
      ex_ctrl.csr =/= CSR.N || ex_ctrl.jalr || ex_ctrl.mem || ex_ctrl.mul || ex_ctrl.div || ex_ctrl.fp || ex_ctrl.rocc || ex_scie_pipelined
    ...
    val mem_cannot_bypass =
      mem_ctrl.csr =/= CSR.N || mem_ctrl.mem && mem_mem_cmd_bh || mem_ctrl.mul || mem_ctrl.div || mem_ctrl.fp || mem_ctrl.rocc
